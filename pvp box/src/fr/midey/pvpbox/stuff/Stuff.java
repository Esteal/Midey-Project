...
public class Stuff implements Listener {
	...
	public static void archer(Player player) {
		...
		player.getInventory().setLeggings(armor(new ItemStack(Material.LEATHER_LEGGINGS), "§9Jambière du clampin", 2, 0, 0, 0, 0, 0));
		...
		player.getInventory().setItem(0,sword(new ItemStack(Material.WOOD_SWORD), "§9Épée du clampin",0, 1, 0));
		player.getInventory().setItem(1, Bow(new ItemStack(Material.BOW), "§9Arc du clampin",3, 1, 0, 0));
		player.getInventory().setItem(2, EnchantedFeed(new ItemStack(Material.SUGAR), "§9Sniffff moi ça mon rheuf"));
	...
	public static void berserker(Player player) {
		...
		player.getInventory().setLeggings(armor(new ItemStack(Material.LEATHER_LEGGINGS), "§2Jambière du bourrin", 3, 0, 0, 0, 0, 0));
	...
	public static void berserker2(Player player) {
		...
		player.getInventory().setLeggings(armor(new ItemStack(Material.LEATHER_LEGGINGS), "§2Jambière du §4GROS §2bourrin", 1, 0, 0, 0, 0, 0));
	...
	public static void monk(Player player) {
		...
		clearEffect(player);
		player.addPotionEffect(new PotionEffect(PotionEffectType.SATURATION, Integer.MAX_VALUE, 255));
		player.getInventory().setBoots(armor(new ItemStack(Material.CHAINMAIL_BOOTS), "§1Bottes du croisé", 3, 0, 0, 0, 2, 0));
		player.getInventory().setLeggings(armor(new ItemStack(Material.LEATHER_LEGGINGS), "§1Jambière du croisé", 3, 0, 0, 0, 2, 0));
		player.getInventory().setChestplate(armor(new ItemStack(Material.LEATHER_CHESTPLATE), "§1Plastron du croisé", 3, 0, 0, 0, 2, 0));
		player.getInventory().setHelmet(armor(new ItemStack(Material.CHAINMAIL_HELMET), "§1Casque du croisé", 3, 0, 0, 0, 2, 0));
		player.getInventory().setItem(0, sword(new ItemStack(Material.STONE_SWORD),"§1Épée du croisé", 2, 0, 0));
	...
	public static void assassin(Player player) {
		...
		player.getInventory().setLeggings(armor(new ItemStack(Material.CHAINMAIL_LEGGINGS), "§7Jambière du fdp", 1, 0, 0, 0, 2, 0));
		...
		player.getInventory().setItem(0, sword(new ItemStack(Material.GOLD_SWORD),"§7Épée du fdp", 3, 0, 0));
		player.getInventory().setItem(1, EnchantedFeed(new ItemStack(Material.EYE_OF_ENDER), "§7Furtivité"));
	...
	public static void assassin2(Player player) {
		...
		player.getInventory().setItem(2, EnchantedFeed(new ItemStack(Material.CHEST), "§7Ton stuff est là dedans !"));
		player.updateInventory();
	}
	...
	public static void paladin(Player player) {
		...
		player.getInventory().setItem(1, EnchantedFeed(new ItemStack(Material.IRON_BLOCK), "Résiste plus !"));
